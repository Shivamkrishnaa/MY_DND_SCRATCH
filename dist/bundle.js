 ...
 * LICENSE file in the root directory of this source tree.
 */
var f=__webpack_require__(504),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
 ...
 * LICENSE file in the root directory of this source tree.
 */
var g=__webpack_require__(504);function n(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var p="function"===typeof Object.is?Object.is:n,q=g.useSyncExternalStore,r=g.useRef,t=g.useEffect,u=g.useMemo,v=g.useDebugValue;
...
const Block = _ref => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "m-3 bg-blue-500 text-white my-2 text-sm cursor-pointer"
  }, /*#__PURE__*/react.createElement("div", {
    className: "px-4 py-3"
  }, uId, " : ", id, " : ", action, " : ", rootId));
};
// EXTERNAL MODULE: ./node_modules/use-sync-external-store/with-selector.js
var with_selector = __webpack_require__(728);
...
var useIsomorphicLayoutEffect = canUseDOM ? react_redux_React.useLayoutEffect : react_redux_React.useEffect;
...
function connect(mapStateToProps, mapDispatchToProps, mergeProps, {
  ...
  const wrapWithConnect = (WrappedComponent) => {
    ...
    function ConnectFunction(props) {
      ...
      const lastChildProps = react_redux_React.useRef();
      const lastWrapperProps = react_redux_React.useRef(wrapperProps);
      const childPropsFromStoreUpdate = react_redux_React.useRef();
      const renderIsScheduled = react_redux_React.useRef(false);
      const isProcessingDispatch = react_redux_React.useRef(false);
...
var fast_deep_equal = __webpack_require__(144);
...
function useRegisteredDragSource(spec, monitor, connector) {
    ...
    useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(function registerDragSource() {
        if (itemType != null) {
 ...
 */ function useDrag_useDrag(specArg, deps) {
...
;// CONCATENATED MODULE: ./src/components/DragContainer.js




const DragContainer = _ref => {
  let {
    id
  } = _ref;
  const {
...
const Sidebar = () => {
  const blocks = react_redux_useSelector(state => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "font-bold"
  }, " ", "Events", " "), new Array(blocks).fill(0).map((id, idx) => /*#__PURE__*/react.createElement(DragContainer, {
    key: idx,
    id: idx + 1
  })));
};
...
function useRegisteredDropTarget(spec, monitor, connector) {
    ...
    useIsomorphicLayoutEffect_useIsomorphicLayoutEffect(function registerDropTarget() {
 ...
 * @param deps The memoization deps array to use when evaluating spec changes
 */ function useDrop_useDrop(specArg, deps) {
    const spec = useOptionalFactory(specArg, deps);
...
function midBlockReducer() {
  ...
  let dragged;
  let position;
  dropped = action === null || action === void 0 || (_action$payload = action.payload) === null || _action$payload === void 0 ? void 0 : _action$payload.dropped;
  dragged = action === null || action === void 0 || (_action$payload2 = action.payload) === null || _action$payload2 === void 0 ? void 0 : _action$payload2.dragged;
  position = action === null || action === void 0 || (_action$payload3 = action.payload) === null || _action$payload3 === void 0 ? void 0 : _action$payload3.position;
  switch (action.type) {
    case "MOVE_TO_MID":
      if (isGlobalBlock(dropped)) {
        return immutability_helper_default()(state, {
          blocks: {
            $push: [{
              position: {
        ...
        return immutability_helper_default()(newState, {
          blocks: {
            $push: [{
              position: {
      ...
      if (isGlobalBlock(dragged)) {
        return immutability_helper_default()(state, {
          blocks: {
            [dropped.rootIdx]: {
              children: {
                $splice: !addAfterItemIdx ? [[dropped.idx + 1, 0, {
                  ...dragged
                }]] : [[dropped.idx, 0, {
                  ...dragged
                }]]
...
;// CONCATENATED MODULE: ./src/components/DragDropContainer.js
...
const DragDropContainer = _ref => {
  ...
  const [{
    ...
    isOverCurrent,
    clientOffset
  }, drop] = useDrop_useDrop(() => ({
    accept: utils_ItemTypes.MOTION,
    drop(item, monitor) {
      var _ref$current;
      ...
      const payload = {
        ...
        position: {
          ...
          hoverBoundingRect: (_ref$current = ref.current) === null || _ref$current === void 0 ? void 0 : _ref$current.getBoundingClientRect(),
          clientOffset: monitor.getClientOffset()
        }
      };
      dispatch({
        type: "MOVE_IN_CONTAINER",
        payload
      });
    },
    collect: monitor => ({
  ...
  (0,react.useEffect)(() => {
    var _document;
    (_document = document) === null || _document === void 0 || (_document = _document.getElementById(styleId)) === null || _document === void 0 || _document.remove();
    const styleTag = document.createElement('style');
    styleTag.id = styleId;
    if (isDragging) {
      // Dynamically add CSS to the <head> element
      const className = "item-".concat(rootIdx, "-").concat(idx);
      styleTag.innerHTML = "\n              .".concat(className, " {\n                display: none;\n              }\n              .").concat(className, " ~ * {\n                display: none;\n              }\n       ");
      document.head.insertAdjacentElement('beforeend', styleTag);
    }
  }, [isDragging, rootIdx, idx]);
  let className = "item-".concat(rootIdx, "-").concat(idx);
  if (isOver) {
    var _ref$current2;
    const isOnTop = checkIsHoveringAbove({
      hoverBoundingRect: (_ref$current2 = ref.current) === null || _ref$current2 === void 0 ? void 0 : _ref$current2.getBoundingClientRect(),
      clientOffset
    });
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: className,
    ref: ref
  }, JSON.stringify(clientOffset), /*#__PURE__*/react.createElement(Block, {
    idx: idx,
    rootId: rootIdx,
    id: id,
    action: action
...
;// CONCATENATED MODULE: ./src/components/BlockContainer.js




const BlocksContainer = /*#__PURE__*/(0,react.memo)(_ref => {
  let {
    idx: rootIdx
  } = _ref;
  ...
  return new Array(childrensCount).fill(childrensCount).map((id, idx) => {
    return /*#__PURE__*/react.createElement(DragDropContainer, {
      key: idx,
      rootIdx: rootIdx,
      idx: idx
    });
...
const Box = _ref => {
  ...
  return /*#__PURE__*/react.createElement("div", {
    className: "absolute",
    style: {
      top: "calc(".concat(top, "px - ", 2, "rem)"),
      left: "calc(".concat(left, "px - ", 15, "rem)")
    }
  }, /*#__PURE__*/react.createElement("div", {
    className: "flex flex-col flex-wrap px-3 py-1 "
  }, /*#__PURE__*/react.createElement(BlocksContainer, {
    idx: idx
  })));
};
...
function MidArea() {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ref: ref,
    className: "midarea h-full w-full",
    style: styles
  }, /*#__PURE__*/react.createElement("div", {
    className: "font-bold"
  }, " ", "Midarea", " "), new Array(blocksCount).fill(0).map((id, idx) => /*#__PURE__*/react.createElement(Box, {
    idx: idx,
    key: idx
  })));
}
...
;// CONCATENATED MODULE: ./src/components/SpriteDragDropContainer.js
...
const SpriteDragDropContainer = _ref => {
  let {
    id,
    left,
    top,
...
function PreviewArea() {
  const [sprite, setSprite] = (0,react.useState)({
    id: 1,
    top: 20,
    left: 80,
    title: 'Drag me around'
  });
  const moveBox = (0,react.useCallback)((id, left, top) => {
    console.log(id, left, top, ' ');
    setSprite(immutability_helper_default()(sprite, {
      $merge: {
        left,
        top
      }
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    div: true,
    ref: drop,
    style: PreviewArea_styles
  }, /*#__PURE__*/react.createElement(SpriteDragDropContainer, {
    id: sprite.id,
    top: sprite.top,
    left: sprite.left,
    title: sprite.title
...
function SideBlocks(_ref) {
  ...
  const [collected, drag] = useDrag(() => ({
    ...
    item: {
      ...
      var _monitor$isOver, _monitor$didDrop, _monitor$getDifferenc, _monitor$getInitialSo;
      console.error('SideBlocks : useDrag : end');
      console.log('item :', item);
      console.log('scope item :', {
        index
      });
      console.log('monitor.isOver():', monitor === null || monitor === void 0 || (_monitor$isOver = monitor.isOver) === null || _monitor$isOver === void 0 ? void 0 : _monitor$isOver.call(monitor));
      console.log('monitor.didDrop():', monitor === null || monitor === void 0 || (_monitor$didDrop = monitor.didDrop) === null || _monitor$didDrop === void 0 ? void 0 : _monitor$didDrop.call(monitor));
      console.log('monitor.getDifferenceFromInitialOffset():', monitor === null || monitor === void 0 || (_monitor$getDifferenc = monitor.getDifferenceFromInitialOffset) === null || _monitor$getDifferenc === void 0 ? void 0 : _monitor$getDifferenc.call(monitor));
      console.log('monitor.getInitialSourceClientOffset():', monitor === null || monitor === void 0 || (_monitor$getInitialSo = monitor.getInitialSourceClientOffset) === null || _monitor$getInitialSo === void 0 ? void 0 : _monitor$getInitialSo.call(monitor));
...
function MySideBar() {
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: "w-60 flex-none h-full overflow-y-auto flex flex-col items-start p-2 border-r border-gray-200"
  }, /*#__PURE__*/React.createElement("ul", null, blocks.map((r, i) => /*#__PURE__*/React.createElement("li", null, /*#__PURE__*/React.createElement(SideBlocks, {
    index: i
  })))));
}
function MyBox() {
  const [{
    ...
    drop(item, monitor) {
      ...
      console.log('item :', item);
      console.log('monitor.isOver(), :', monitor === null || monitor === void 0 ? void 0 : monitor.isOver());
      console.log('monitor.getDifferenceFromInitialOffset() :', monitor === null || monitor === void 0 ? void 0 : monitor.getDifferenceFromInitialOffset());
      console.log('monitor.getInitialSourceClientOffset() :', monitor === null || monitor === void 0 ? void 0 : monitor.getInitialSourceClientOffset());
      console.info('monitor.didDrop() :', monitor === null || monitor === void 0 ? void 0 : monitor.didDrop());
      console.info('monitor.getDropResult() :', monitor === null || monitor === void 0 ? void 0 : monitor.getDropResult());
      console.info('monitor.getItemType() :', monitor === null || monitor === void 0 ? void 0 : monitor.getItemType());
...
function MyMidArea() {
  ...
  return /*#__PURE__*/React.createElement("span", {
    ref: drop,
    className: "whitecontainer h-full w-full"
  }, [1].map(i => /*#__PURE__*/React.createElement(MyBox, {
    idx: i
  })));
}
const Container = () => {
  ...
  }, /*#__PURE__*/React.createElement(MySideBar, null), /*#__PURE__*/React.createElement(MyMidArea, null));
};
...
var withExtraArgument = (/* unused pure expression or super */ null && (createThunkMiddleware));


;// CONCATENATED MODULE: ./src/store/sideBlock.js



const globalSubstring = "g_";
const getGlobalUId = () => (0,lodash.uniqueId)(globalSubstring);
const sideBlockReducer = function () {
  let state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    blocks: {
      1: {
        id: 1,
        uId: getGlobalUId(),
        type: utils_ItemTypes.MOTION,
        action: "Move 10 steps",
        isGlobal: true
      },
      2: {
...
;// CONCATENATED MODULE: ./src/store/blockCoordinate.js

const blocksCoordinatesReducer = function () {
  let state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    blocks: {
      1: {
        id: 1,
...
var redux_logger = __webpack_require__(592);
var redux_logger_default = /*#__PURE__*/__webpack_require__.n(redux_logger);
;// CONCATENATED MODULE: ./src/store/block.js



const block_globalSubstring = "g_";
const block_getGlobalUId = () => uniqueId(block_globalSubstring);
const blocksReducer = function () {
  let state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {
    blocks: {
      1: {
        id: 1,
        uId: block_getGlobalUId(),
...
const middlewareEnhancer = applyMiddleware(thunk, (redux_logger_default()));
...
var jsx_runtime = __webpack_require__(624);
;// CONCATENATED MODULE: ./node_modules/dnd-core/node_modules/redux/es/redux.js
...
function redux_miniKindOf(val) {
  ...
  if (redux_isError(val)) return 'error';
 ...
 * @returns {void}
 */
function es_redux_warning(message) {
...
function redux_getUnexpectedStateShapeWarningMessage(inputState, reducers, action, unexpectedKeyCache) {
  ...
  if (action && action.type === redux_ActionTypes.REPLACE) return;
...
function es_redux_bindActionCreators(actionCreators, dispatch) {
  if (typeof actionCreators === 'function') {
...
react_dom.render( /*#__PURE__*/react.createElement(react.StrictMode, null, /*#__PURE__*/react.createElement(Provider_default, {
  store: src_store
